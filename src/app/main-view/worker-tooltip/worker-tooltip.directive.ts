 ...
 */
@Directive({
  selector: '[spWorkerTooltip]',
  exportAs: 'spWorkerTooltip',
})
export class WorkerTooltip implements OnDestroy, OnInit {
  _overlayRef: OverlayRef | null;
  _tooltipInstance: WorkerTooltipComponent | null;

  private _portal: ComponentPortal<WorkerTooltipComponent>;
  ...
  show(delay: number = this.showDelay): void {
    ...
    this._detach();
    this._portal = this._portal || new ComponentPortal(WorkerTooltipComponent, this._viewContainerRef);
